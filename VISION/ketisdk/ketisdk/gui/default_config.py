...
def default_args():
    ...
    args_.sensor.denoise_ksize = None
    ...
    args_.sensor.save_disp = False
    args_.sensor.intrinsic = (645, 347, 917, 917)
    args_.sensor.depth_scale = 1000.
    ...
    args_.conn = CFG()
    args_.conn.address = 'localhost'
    args_.conn.port = 8888
