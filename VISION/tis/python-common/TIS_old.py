...
#from pgi.repository import GLib, GObject, Gst, Tcam
#from vext.gi.repository import GLib, GObject, Gst, Tcam
...
class TIS:
    ...
    def _setcaps(self):
        ...
        #structure.free()
        structure2, end = structure.from_string(struc_string)
    ...
    def selectFormat(self):
        ...
        self.openDevice(self.serialnumber, width, height, framerate, SinkFormats.BGRA, False)
        return True
